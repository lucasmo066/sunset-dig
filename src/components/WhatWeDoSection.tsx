...
export default function WhatWeDo() {
  return (
    <div>
      <div className="w-full relative max-w-3xl m-5">
        ...
        <div className="relative opacity-90 shadow-xl bg-neutral-950 border border-gray-700 px-4 py-8 h-full overflow-hidden rounded-lg flex flex-col justify-center items-center">
          <h2 className="font-strong text-gray-200 text-3xl text-center mb-4 relative z-50">
          ...
          <button className="border px-4 py-1 rounded-lg border-white text-white">
            Explore Projects
          </button>
