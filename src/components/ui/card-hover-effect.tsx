...
export const CardTitle = ({
  ...
  return (
    <h4 className={cn("w-1/12 text-primary dark:text-zinc-100 font-bold text-center border border-primary dark:border-zinc-100 rounded-full p-4 mt-2", className)}>
      {children}
    </h4>
  );
};
