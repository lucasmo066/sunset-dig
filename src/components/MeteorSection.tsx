  ...
  return (
    <div className="mt-5 md:px-10 lg:px-10 xl:px-30">
      <div className="w-full relative">
        ...
        <div className="norder-4 border-gray-700 flex flex-col justify-center items-center relative opacity-90 shadow-xl bg-neutral-950 px-10 py-10 mx-5 my-10 h-full border-2 overflow-hidden rounded-lg sm:mx-10 sm:py-20 md:mx-40 lg:py-30 xl:mx-80">
